...
INSERT INTO `CONTACT` VALUES (1,'koe','Suomi','h@x.com','uusi','213782137',0,2,1,4),(2,'u','suomi','uuu','u','uuuu',0,1,2,4),(3,'Osoite x','suomi','f@dj.com','Uusi kontakti','132213213',0,2,1,3),(4,'f','','q','a','g',0,0,4,4),(5,'f2','d2','q2','n2','g2',0,1,2,4),(6,'Mikkolantie 12','Suomi','mikko.matikainen@yr.fi','Mikko matikainen','+403232848',0,0,NULL,4);
...
INSERT INTO `CONTACTCOMPANY` VALUES (1,'ss','23432','www.ss.fi','uusi asiakasy'),(2,'d','d','d','d'),(3,'d','d','d','d'),(4,'s','s','s','s');
...
INSERT INTO `CONTRACT` VALUES (1,'status','2016-05-26',2000,'2015-11-10',1,4,NULL,NULL,NULL),(2,'uusi status','2016-10-28',10000,'2016-02-17',1,4,NULL,NULL,NULL),(3,'Draft','2015-12-16',1500,'2015-12-02',1,4,2,23,13),(4,'Draft','2015-12-31',12000,'2015-12-25',1,4,1,22,13),(5,'Draft','2015-12-31',12000,'2015-12-25',1,4,1,22,8);
...
INSERT INTO `CONTRACTS_CONTACTS` VALUES (3,1),(1,2),(3,2),(3,4),(1,5),(3,5);
...
-- Dump completed on 2015-12-03 15:32:45
