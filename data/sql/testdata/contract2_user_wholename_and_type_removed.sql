...
INSERT INTO `CONTACT` VALUES (1,'koe','Suomi','h@x.com','uusi','213782137',0,0,1,4),(2,'u','suomi','uuu','u','uuuu',0,1,2,4),(3,'Osoite x','suomi','f@dj.com','Uusi kontakti','132213213',0,0,1,3),(4,'f','','q','a','g',0,0,NULL,4),(5,'f','d','q','a','g',0,0,2,4);
...
INSERT INTO `USER` VALUES (2,'','','','',''),(3,'Harri','Mäenpää','x','hamaenpaa','ADMIN'),(4,'Kalle','Muittari','admin','admin','ADMIN'),(5,'Uusi','Käyttäjä','uusik','uusik','');
...
-- Dump completed on 2015-11-26 11:31:08
